...
const manualSections: ManualSection[] = [
  {
    ...
    contentEn: [
      "HARBOR (Health Analytics, Rescue Backup & Operations Routing) is an AI-powered health app that helps you take care of your health with intelligent support from anywhere in Pakistan.",
    ...
    contentUr: [
      "HARBOR (ہیلتھ اینالیٹکس، ریسکیو بیک اپ اور آپریشنز روٹنگ) ایک AI سے چلنے والی صحت کی ایپ ہے جو آپ کو پاکستان میں کسی بھی جگہ سے اپنی صحت کی دیکھ بھال کرنے میں ذہین مدد دیتی ہے۔",
      "اہم خصوصیات:",
